                ...
                <div class="card-body">
                    ...
                    if (isset($_POST['editprofile'])) {
                        ...
                        if (isset($username) && isset($email)) {
                            if ($user == $user['username'] && $email == $user['email'] && $alamat == $user['alamat']) {
                    ...
                    <?php echo @$alert; if (@$_GET['proses'] == 'editprofile') : ?>
                        <form action="?url=profile&&proses=editprofile" method="post">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" value="<?= $user['namalengkap'] ?>" id="nama" name="nama" required placeholder="Masukkan Nama Lengkap">
                            </div>
                            <div class="input-group mb-3">
                                <label for="email" class="input-group-text"><i class="fa-solid fa-envelope fa-fw fa-lg"></i></label>
                                <input type="email" class="form-control" value="<?= $user['email'] ?>" id="email" name="email" required placeholder="Masukkan Email Anda">
                            </div>
                            <div class="input-group mb-3 ">
                                <label for="username" class="input-group-text"><i class="fa-solid fa-at fa-fw fa-lg"></i></label>
                                <input type="text" class="form-control" value="<?= $user['username'] ?>" id="username" name="username" required placeholder="Masukkan username">
                            </div>
                            <div class="input-group mb-4">
                                <label for="alamat" class="input-group-text"><i class="fa-solid fa-address-book fa-fw fa-lg"></i></label>
                                <input type="text" class="form-control" value="<?= $user['alamat'] ?>" id="alamat" name="alamat" required placeholder="Masukkan Alamat Lengkap">
                            </div>
